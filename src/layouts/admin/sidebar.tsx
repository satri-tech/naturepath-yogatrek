...
const Sidebar = () => {
    return (
      <div className="h-screen dark:bg-slate-900 md:block hidden shadow-md">
        ...
        <div
          id="sidebar"
          className="dark:bg-slate-900  md:block px-3 w-30 h-[90%] md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-200 ease-in-out"
        >
          <Menu />
        </div>
      </div>
