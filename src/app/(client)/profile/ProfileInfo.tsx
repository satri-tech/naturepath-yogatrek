    ...
    return (
        <div className="p-6 bg-white text-black shadow-lg rounded-lg mb-6 flex items-center space-x-6">
            ...
            <div>
                ...
                Welcome to a journey of self-discovery and holistic well-being through yoga. My name is Ghimiray, 
                    and I am dedicated to instructing yoga perfectly, guiding you to find balance, strength, and peace 
                    within yourself. Join me to master the art of yoga with precision and care.
                </p>
